...
public class NewPoiUtil {
    ...
    public static String downExcel(List<Item> list,String realPath){
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            cell.setCellValue(String.valueOf(list.get(i).getPrice()));
            cell.setCellStyle(lieStyle(workbook));
...
//            cell.setCellStyle(contentStyle(workbook));
            ...
            cell.setCellValue(String.valueOf(list.get(i).getNum()));

            cell = row.createCell(7);
            if(list.get(i).getCatagory().getName()!=null){
                cell.setCellValue(list.get(i).getCatagory().getName());
                cell.setCellStyle(contentStyle(workbook));
            }else{
                cell.setCellValue("");
                cell.setCellStyle(contentStyle(workbook));
