...
<body>
<div id="loginDialogsss" title="用户登录" style="display: none;">
	<form id="loginForm" method="post">
	    <div>
	        <label for="phone">账户名称:</label>
	        <input class="easyui-validatebox" type="text"  value="18234231422" name="phone" data-options="required:true" />
	    </div>

		<div>
	        <label for="password">账户密码:</label>
	        <input class="easyui-validatebox" type="password" value="qq000000" name="password"
	 ...
	 function loginUser(){
	      	$.ajax({
            		url:sys.contextPath+'/httpsss/httpuser.do',
            		type:'post',
            		//同步
            		async:false,
            		...
            		success:function(data){
            			...
            			if (data.success) {
            				//alert(data.success);
            				window.location.href=sys.contextPath+"/httpsss/tohttpitemlist.do";
        				}else{
